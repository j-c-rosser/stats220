...
Messages received did not include messages received from group chats.
The following data was collected:
date_completed - The time and date the survey was completed,
time_received - categorical variable of time the message was received,
regular_contact -  whether the sender is a person communicated with on atleast a weekly basis
app_type - whether the message was received on a message based app (eg texts, facebook messenger) or social media app (eg instagram),
sender - The category of relationship the sender belongs to,
words - The number of words in the message, and
response_time - The time taken to respond to the message received.
